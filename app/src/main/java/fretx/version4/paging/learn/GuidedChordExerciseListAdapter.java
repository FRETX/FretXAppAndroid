...
import fretx.version4.paging.play.CustomGridViewAdapter;

/**
 * Created by Kickdrum on 04-Jan-17.
 */

public class GuidedChordExerciseListAdapter extends ArrayAdapter<GuidedChordExercise> {

	MainActivity context;
	int layoutResourceId;
	ArrayList<GuidedChordExercise> data = new ArrayList<GuidedChordExercise>();

	GuidedChordExerciseListAdapter(MainActivity context , int layoutResourceId, ArrayList<GuidedChordExercise> data){
